...
// PROTOTIPO ARRAY 
 /*    $prototype_faq = [
    ...
    var_dump($prototype_faq); */
    // PROTOTIPO CICLI

   /*  foreach($prototype_faq as $topic){
 ...
 */
    ...
    $faq = [
        ...
        //METTERE OL LI IN QUESTA DOMANDA 
        [
            'question' => "Perché il mio account è associato a un paese?" ,
            'answer' =>"    La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
